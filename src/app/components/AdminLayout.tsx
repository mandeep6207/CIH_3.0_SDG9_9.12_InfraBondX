...
export function AdminLayout({ children, currentPage, onNavigate }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { id: "verify-issuers", label: "Verify Issuers" },
    { id: "approve-projects", label: "Approve Projects" },
        ...
        <div className="px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="ml-2 text-xs px-2 py-1 bg-accent rounded">Admin Portal</span>
            </div>
          </div>

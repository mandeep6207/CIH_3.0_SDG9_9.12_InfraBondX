...
import { LayoutDashboard, FileText, TrendingUp, LogOut, Building2, Bell, User, Upload } from "lucide-react";
...
export function IssuerLayout({ children, currentPage, onNavigate }: IssuerLayoutProps) {
  const { user, logout } = useAuth();

  const menuItems = [
    { id: "issuer-dashboard", icon: LayoutDashboard, label: "Dashboard" },
    { id: "create-bond", icon: FileText, label: "Create Bond" },
    { id: "milestones", icon: Upload, label: "Milestones" },
  ];
        ...
        <div className="px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="ml-2 text-xs px-2 py-1 bg-accent rounded">Issuer Portal</span>
            </div>
          </div>
